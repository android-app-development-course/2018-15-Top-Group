...
public class Fragment_calendar extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.activity_calender, container, false);
        pager = (ViewPager) view.findViewById(R.id.view_page);
        initData();
        ViewAdapter adapter = new ViewAdapter(getChildFragmentManager(), frags);
        ...
        pager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
                ...
                if (position == 0) {
                    ...
                    dayshow = (TextView) view.findViewById(R.id.dayshow);
