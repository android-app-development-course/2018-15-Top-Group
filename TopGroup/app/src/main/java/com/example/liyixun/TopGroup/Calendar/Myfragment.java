...
public class Myfragment extends Fragment{
                        ...
                        Fab.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                    if (groupname == null) return;
                                     ...
                                     intent.putExtra("username",activity.getMuser().getNickname());
                                     intent.putExtra("groupname",activity.getMGroup().getGroupname());
    ...
    public void initData(String groupname){
        ...
        query.setLimit(50);
        //执行查询方法
        query.findObjects(new FindListener<com.example.liyixun.TopGroup.Calendar.Calendar>(){
            @Override
